...
function [ Ireg ] = imageRegistration_2D( I, u, v )

%% Wrap image I using 2D motion field (horizontal component: u, vertical component: v)
  [lig,col] = size(I);
  
  [c l] = meshgrid(1:col,1:lig);
  l=l+u; l(l<1)=1; l(l>col)=col; l(isnan(l))=0;

  c=c+v; c(c<1)=1; c(c>lig)=lig; c(isnan(c))=0;
  
  Ireg = interp2(I, c, l, 'cubic');
